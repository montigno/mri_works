...
script=[S0] title=[Script_editor] inputs=[['list_files', 'in', 'list_path'], ['Atlas_label_nifti', 'in', 'path'], ['Atlas_label_text', 'in', 'path'], ['output_result', 'in', 'path']] outputs=[] code=[your code] RectF=[(230.67553884337556, -260.5514686018141, 631.9312670357447, 908.5759116216127)]
...
[source S0]
['output_result=C5:output_result', 'Atlas_label_text=C0:Atlas_label_text', 'Atlas_label_nifti=C4:Atlas_label_nifti', 'list_files=U0:path_list']
import numpy as np
