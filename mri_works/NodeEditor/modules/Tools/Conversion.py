...
class StringToEval():
    def __init__(self,inString=''):
        ...
        listType = ['float','int','str','bool','path','listfloat','listint','liststr', 'listbool','listpath','arrayfloat','arrayint','arraystr','arraybool','arraypath']
        self.listVar= []
...
class CSVToList():
    def __init__(self,input_CSV=''):
        import csv
#         self.output = [float(s) for line in input_CSV.splitlines() for s in line[:-1].split(',')]
