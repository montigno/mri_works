class ants_MeasureImageSimilarity():
    ...
    def __init__(self, moving_image='path', fixed_image='path',
                       metric="enumerate(('CC', 'MeanSquares', 'Demons'))",
                       sampling_percentage=0.0, radius_or_number_of_bins=0, **options):
...
class ants_Registration():
    ...
    def __init__(self, moving_image=['path'], fixed_image=['path'],
                       ...
                       transforms=['Affine', 'BSplineSyN'], shrink_factors=[[2, 1], [3, 2, 1]],
