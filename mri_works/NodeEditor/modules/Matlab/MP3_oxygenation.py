class MP3_CMRO2():
    def __init__(self, mat_eng='', file_CBF='path', file_SO2='path', file_out='path', **options):
...
class MP3_R2Prim():
    def __init__(self, mat_eng='', file_T2Map='path', file_T2StarCorr3D='path', file_out='path', **options):
        import matlab.engine
        files_in , files_out = {}, {}
        options['flag_test'] = 0
...
class MP3_SO2():
    def __init__(self, mat_eng='', file_R2Prim='path', file_BVf='path', file_out='path', **options):
        import matlab.engine
        files_in , files_out = {}, {}
        options['flag_test'] = 0
