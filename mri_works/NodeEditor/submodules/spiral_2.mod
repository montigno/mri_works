[diagram]
block=[U2] category=[Numpy.Functions_trigo] class=[numpy_cos] valInputs=[(['x', 'angle_type'], ['Node(N2)', 'Node(N14)'], ['cosinus'], ['float'])] RectF=[(-255.82411842272296, -175.0, 151.734375, 80.0)]
block=[U3] category=[Numpy.Functions_trigo] class=[numpy_sin] valInputs=[(['x', 'angle_type'], ['Node(N3)', 'Node(N15)'], ['sinus'], ['float'])] RectF=[(-308.82411842272296, 73.0, 150.0, 80.0)]
...
connt=[C5] name=[angle_type] type=[in] format=[str] valOut=[enumerate(('degree','radian'))] RectF=[(-793.4489488180809, 161.32242673118947, 70, 24)]
