[diagram]
constant=[A12] value=['For Bruker'] format=[str] label=[in0] RectF=[(2207.674783440139, 140.01864882727148, 97.0, 33.0)]
...
link=[N21] node=[C1:path_raw_Bruker#Node#U16:in_file]
link=[N17] node=[C0:path_Nifti_reference#Node#U13:RepDefault]
link=[N47] node=[A13:#Node#U25:in_String]
link=[N46] node=[A12:#Node#I0:in0]
...
link=[N20] node=[U16:ListPath#Node#U1:Bruker_files]
link=[N42] node=[A11:#Node#U21:y]
link=[N49] node=[I0:in0#Node#U25:comment]
link=[N48] node=[A14:#Node#U26:in_String]
link=[N50] node=[I0:in0#Node#U26:comment]
...
block=[U23] category=[Tools.Print] class=[Print_bool] valInputs=[(['comment', 'inBool'], ['', 'Node(N33)'], [], [])] RectF=[(1883.283733673788, -82.80051103191656, 150.0, 80.0)]
...
block=[U25] category=[Tools.Print] class=[Print_str] valInputs=[(['comment', 'in_String'], ['Node(N49)', 'Node(N47)'], [], [])] RectF=[(2563.9084663076687, 144.92029166219336, 150.0, 80.0)]
constant=[A13] value=["it's all good !"] format=[str] label=[in_String] RectF=[(2397.534432947, 216.76362539235146, 111.0, 33.0)]
constant=[A14] value=['error'] format=[str] label=[in_String] RectF=[(2409.1263454103887, 211.06226519213703, 60.0, 33.0)]
block=[U26] category=[Tools.Print] class=[Print_str] valInputs=[(['comment', 'in_String'], ['Node(N50)', 'Node(N48)'], [], [])] RectF=[(2546.482265505892, 129.27270926047086, 152.0, 82.0)]
connt=[C1] name=[path_raw_Bruker] type=[in] format=[path] valOut=[path] RectF=[(-1432.936592891217, -0.9539910250798442, 70, 24)]
connt=[C0] name=[path_Nifti_reference] type=[in] format=[path] valOut=[path] RectF=[(-1415.2018000121427, -245.62907234762397, 70, 24)]
loopIf=[I0] inputs=[[[['in0', 'in', 'str'], ['in0', 'out', 'str']]]] outputs=[[]] listItems=[[['U25', 'A13'], ['U26', 'A14']]] RectF=[(2376.471398910826, 36.46268364412302, 380.41733687439, 260.44475017477015)]
block=[U24] category=[Tools.Comparison_operations] class=[all_iterable] valInputs=[(['list_bool'], ['Node(N44)'], ['out'], ['bool'])] RectF=[(2151.212786403206, 8.080243182859789, 150.0, 80.0)]
loopFor=[F0] inputs=[[[['in0', 'in', 'list_path'], ['in0', 'out', 'path']], [['in1', 'in', 'list_path'], ['in1', 'out', 'path']]]] outputs=[[[['out0', 'in', 'bool'], ['out0', 'out', 'list_bool']]]] listItems=[['U12', 'U7', 'U14', 'A7', 'U21', 'U19', 'U17', 'A11', 'U20', 'U22', 'U4', 'U8', 'A4', 'U5', 'U23', 'U2', 'U11', 'U3', 'U6', 'U9', 'A6', 'U18', 'A5', 'U10']] RectF=[(-153.37921366106298, -354.55724789635144, 2227.213494213255, 804.4447196579645)]
...
block=[U1] category=[Java.MRIFileManager] class=[BrukerToNifti] valInputs=[(['Bruker_files', 'naming', 'path_export', 'bvals_bvecs'], ['Node(N20)', 'Node(N30)', 'Node(N31)', 'Node(N32)'], ['list_files_exported'], ['list_path'])] RectF=[(-666.1026442437969, 56.606742578430584, 232.421875, 229.63497696571957)]
...
comments=[] RectF=[(-679.984981471245, 8.394876314459793, 270.5169610414625, 326.2924026036561)] text=['mri_conv']
[execution]
['C0:path_Nifti_reference=', 'C1:path_raw_Bruker=']
['ThreadOn', 'U16', 'U13', 'ThreadOff', 'ThreadOn', 'U1', 'U0', 'ThreadOff', 'U15', 'F0', 'U24', 'I0']
{'U16': ('Tools.PathManipulation', 'ToListPath', "(['in_file'], ['C1:path_raw_Bruker'], ['ListPath'], ['list_path'])"), 'U15': ('Tools.PathManipulation', 'order_name_files', "(['files_list', 'reverse'], ['U1:list_files_exported', False], ['list_out'], ['list_path'])"), 'U0': ('Tools.PathManipulation', 'order_name_files', "(['files_list', 'reverse'], ['U13:listFiles', False], ['list_out'], ['list_path'])"), 'U24': ('Tools.Comparison_operations', 'all_iterable', "(['list_bool'], ['F0:out0'], ['out'], ['bool'])"), 'U1': ('Java.MRIFileManager', 'BrukerToNifti', "(['Bruker_files', 'naming', 'path_export', 'bvals_bvecs'], ['U16:ListPath', 'PatientName-StudyName-CreationDate-SeqNumber-Protocol-SequenceName-AcquisitionTime', '/tmp/', False], ['list_files_exported'], ['list_path'])"), 'U13': ('File_IO.Dialog_files_directories', 'list_files_in_directory', "(['RepDefault', 'title', 'filter', 'recursive'], ['C0:path_Nifti_reference', 'Select a directory', '*.nii', True], ['listFiles'], ['list_path'])")}
['I0:in0', 'A14:', 'I0:in0', 'A11:', 'U16:ListPath', 'A10:', 'A9:', 'A8:', 'A2:', 'A1:', 'U1:list_files_exported', 'U15:list_out', 'U0:list_out', 'U13:listFiles', 'F0:in1', 'F0:in1', 'F0:in0', 'F0:in0', 'U5:nii_affine', 'F0:in0', 'A4:', 'A7:', 'A5:', 'A6:', 'A11:', 'A11:', 'F0:out0', 'U24:out', 'A12:', 'A13:', 'C0:path_Nifti_reference', 'C1:path_raw_Bruker']
{}
[]
[loopfor F0]
['F0:in1=U15:list_out', 'F0:in0=U0:list_out', 'I0:in0=For Bruker']
['ThreadOn', 'U2', 'U3', 'U5', 'U7', 'U9', 'ThreadOff', 'U10', 'U4', 'U8', 'U12', 'U6', 'U11', 'U19', 'U20', 'U21', 'U22', 'ThreadOn', 'U14', 'U17', 'U18', 'U23', 'ThreadOff']
...
['F0:in1', 'F0:in1', 'F0:in0', 'F0:in0', 'U5:nii_quaternions', 'U7:nii_quaternions', 'U5:nii_affine', 'U7:nii_affine', 'U4:image', 'U2:image', 'U3:image', 'F0:in0', 'U6:rms', 'U8:image', 'U10:listSub', 'U12:rms', 'U11:rms', 'U22:out', 'U12:rms', 'U11:rms', 'U6:rms', 'U19:out', 'U20:out', 'U21:out', 'U22:out']
{}
['F0:out0=U22:out']
[loopif I0 True]
['I0:val=U24:out', 'I0:in0=For Bruker']
['U25']
{'U25': ('Tools.Print', 'Print_str', '([\'comment\', \'in_String\'], [\'I0:in0\', "it\'s all good !"], [], [])')}
['I0:in0']
{}
[]
[loopif I0 False]
['I0:val=U24:out', 'I0:in0=For Bruker']
['U26']
{'U26': ('Tools.Print', 'Print_str', "(['comment', 'in_String'], ['I0:in0', 'error'], [], [])")}
['I0:in0']
{}
[]
