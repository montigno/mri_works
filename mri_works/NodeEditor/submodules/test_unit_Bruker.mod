[diagram]
constant=[A12] value=['For Bruker'] format=[str] label=[in0] RectF=[(2612.2181468230374, -74.99455612033188, 97.0, 33.0)]
...
link=[N46] node=[A13:#Node#I0:out0]
link=[N47] node=[I0:out0#Node#U25:in_String]
link=[N48] node=[A14:#Node#I0:out0]
...
constant=[A13] value=["it's all good !"] format=[str] label=[in_String] RectF=[(2402.3125041680573, 148.27793789052222, 111.0, 33.0)]
constant=[A14] value=['error !'] format=[str] label=[in_String] RectF=[(2451.0535390907844, 149.6340511952779, 68.0, 33.0)]
...
loopIf=[I0] inputs=[[]] outputs=[[[['out0', 'in', 'str'], ['out0', 'out', 'str']]]] listItems=[[['A13'], ['A14']]] RectF=[(2376.471398910826, 36.46268364412302, 245.03865227775123, 233.36901325544233)]
...
block=[U25] category=[Tools.Print] class=[Print_str] valInputs=[(['comment', 'in_String'], ['Node(N49)', 'Node(N47)'], [], [])] RectF=[(2775.7362904412335, -65.31484206435216, 150.0, 80.0)]
