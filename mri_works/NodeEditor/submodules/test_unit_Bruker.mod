...
constant=[A4] value=['file : '] format=[str] label=[comment] RectF=[(-94.4138183350583, -305.3657093844701, 58.0, 33.0)]
block=[U9] category=[Tools.Print] class=[Print_path] valInputs=[(['comment', 'inPath'], ['Node(N14)', 'Node(N9)'], [], [])] RectF=[(49.804594798889184, -312.7937189990388, 150.0, 80.0)]
...
block=[U7] category=[Nifti.Info_Nifti] class=[Nifti_affine_quaternion] valInputs=[(['nii_image'], ['Node(N0)'], ['nii_affine', 'nii_quaternions'], ['array_float', 'list_float'])] RectF=[(-0.04036961535757655, -175.130270042686, 201.171875, 82.0)]
...
loopFor=[F0] inputs=[[[['in0', 'in', 'list_path'], ['in0', 'out', 'path']], [['in1', 'in', 'list_path'], ['in1', 'out', 'path']]]] outputs=[[]] listItems=[['U19', 'U6', 'A6', 'U8', 'U12', 'U17', 'U22', 'U20', 'A5', 'U11', 'U23', 'U4', 'U7', 'U2', 'U21', 'U5', 'U9', 'U10', 'U14', 'A7', 'A4', 'A11', 'U18', 'U3']] RectF=[(-153.37921366106298, -354.55724789635144, 2227.213494213255, 804.4447196579645)]
