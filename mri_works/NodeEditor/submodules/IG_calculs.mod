...
script=[S0] title=[Script_editor] inputs=[['list_masks', 'in', 'list_path'], ['list_files', 'in', 'list_path'], ['output_result', 'in', 'path']] outputs=[] code=[your code] RectF=[(230.67553884337556, -260.5514686018141, 673.6870006461485, 542.7148151440499)]
...
[source S0]
['output_result=C4:outfile_result_name', 'list_masks=U2:list_out', 'list_files=U0:path_list']
import numpy as np
...
print('ref. for volume :', list_files[0])
hdr =  nib.load(list_files[0]).header
...
{'U2': ('Tools.PathManipulation', 'order_name_files', "(['files_list', 'reverse'], ['C0:list_structures', False], ['list_out'], ['list_path'])"), 'U0': ('Tools.PathManipulation', 'build_list_path_dyn', "(['in_path', 'in_path_0', 'in_path_1'], ['C1:T1_Flash Nifti', 'C2:Diff FA Nifti', 'C3:Diff MD Nifti'], ['path_list'], ['list_path'])")}
['C4:outfile_result_name', 'C1:T1_Flash Nifti', 'C2:Diff FA Nifti', 'C3:Diff MD Nifti', 'C0:list_structures', 'U2:list_out', 'U0:path_list']
{}
[]
