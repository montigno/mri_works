...
script=[S1] title=[Script_editor] inputs=[['in0', 'in', 'list_int']] outputs=[] code=[your code] RectF=[(172.15668304457336, 238.0253269920624, 200.0, 200.0)]
...
script=[S0] title=[Script_editor] inputs=[['in0', 'in', 'int'], ['in1', 'in', 'float'], ['in3', 'in', 'bool']] outputs=[['out5', 'out', 'list_path']] code=[your code] RectF=[(-231.3666265608741, -34.856513397502596, 200.0, 200.0)]
