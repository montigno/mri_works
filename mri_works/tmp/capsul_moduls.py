...
''')
def div_int_dyn3(int1, int2, int2_0):
...
''')
def mult_int_dyn3(int1, int2, int2_0):
	listInputs=dict(zip(('int1', 'int2', 'int2_0'),(int1, int2, int2_0)))
...
''')
def sub_int_dyn3(int1, int2, int2_0):
	listInputs=dict(zip(('int1', 'int2', 'int2_0'),(int1, int2, int2_0)))
...
''')
def add_int_dyn3(int1, int2, int2_0):
	listInputs=dict(zip(('int1', 'int2', 'int2_0'),(int1, int2, int2_0)))
...
''')
def div_float_dyn3(in1, in2, in2_0):
...
''')
def mult_float_dyn3(in1, in2, in2_0):
	listInputs=dict(zip(('in1', 'in2', 'in2_0'),(in1, in2, in2_0)))
...
''')
def sub_float_dyn3(in1, in2, in2_0):
	listInputs=dict(zip(('in1', 'in2', 'in2_0'),(in1, in2, in2_0)))
