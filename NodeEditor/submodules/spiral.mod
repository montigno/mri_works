...
['U0:outAbscissa', 'F0:in0', 'F0:in0', 'F0:in0', 'F0:in0', 'F0:out0', 'F0:out1', 'C2:xmin', 'C3:xmax', 'C4:delta_x']
{}
['C0:out0=F0:out0', 'C1:out1=F0:out1']
[loopfor F0]
['F0:in0=U0:outAbscissa']
['ThreadOn', 'U2', 'U3', 'ThreadOff', 'ThreadOn', 'U4', 'U5', 'ThreadOff']
{'U2': ('Numpy.Functions_trigo', 'numpy_cos', "(['x', 'angle_type'], ['F0:in0', 'degree'], ['cosinus'], ['float'])"), 'U3': ('Numpy.Functions_trigo', 'numpy_sin', "(['x', 'angle_type'], ['F0:in0', 'degree'], ['sinus'], ['float'])"), 'U4': ('Tools.SimpleOperation', 'mult_float_dyn', "(['in1', 'in2'], ['U2:cosinus', 'F0:in0'], ['multiplication'], ['float'])"), 'U5': ('Tools.SimpleOperation', 'mult_float_dyn', "(['in1', 'in2'], ['F0:in0', 'U3:sinus'], ['multiplication'], ['float'])")}
['F0:in0', 'F0:in0', 'U2:cosinus', 'U3:sinus', 'F0:in0', 'F0:in0', 'U4:multiplication', 'U5:multiplication']
{}
